...
export const QuestionData: IQuestion[] = [
  ...
  },
  {
    ...
    answera:
      "'OO이 너무 이쁜 것 같아.. 사람들한테 자랑해야지..!!'하며 인스타를 만들어서 사진도 공유하고 소통도 한다.",
  ...
  },
  {
    ...
    answerb: '사람이 중요하지!! 원장님의 성격이 좋다고 되어 있는 병원',
    type: 'TF',
  },
  {
    id: 10,
    ...
    answera:
      "'우리 고양이 몸무게는 ??키로니까 하루세번 몇시에 이만큼 씩 주고, 간식은 이때 챙겨줘야겠다. 영양제도 미리미리 준다.'",
  ...
  },
  {
    ...
    answera:
      '사료를 조금씩 금여해서 고양이의 기호를 테스트 해보고 다 잘먹는다면 날짜에 맞춰서 질리지 않도록 바꿔가며 급여한다.',
